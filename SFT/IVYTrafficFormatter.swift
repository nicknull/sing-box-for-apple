...
private class IVYTrafficFormatter: NumberFormatter {
    
    static let `default` = IVYTrafficFormatter()
...
enum ClashTrafficFormatterKey: EnvironmentKey {
    static let defaultValue: NumberFormatter = IVYTrafficFormatter.default
}
